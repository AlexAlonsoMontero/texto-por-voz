    ...
    <ion-content>
      ...
      <div class="theme-section">
        ...
        <ion-item>
          ...
          <ion-input type="color" [(ngModel)]="primaryColor" (ionChange)="onPrimaryColorChange()"> </ion-input>
        </ion-item>
...
@Component({
  ...
  template: `
    ...
    <ion-content>
      <app-theme-settings [currentTheme]="currentTheme" (themeChanged)="onThemeChanged($event)"> </app-theme-settings>

      <app-tts-settings [ttsConfig]="ttsConfig" (configChanged)="onTtsConfigChanged($event)"> </app-tts-settings>

      <app-accessibility-settings [a11yConfig]="a11yConfig" (configChanged)="onA11yConfigChanged($event)">
...
@Component({
  ...
  template: `
    <div class="theme-section">
      ...
      <ion-item>
        <ion-label>Color Primario</ion-label>
        <ion-input type="color" [value]="currentTheme.primary" (ionChange)="onPrimaryColorChange($event)"> </ion-input>
      </ion-item>
...
describe('RefactoredComponent (after refactoring)', () => {
  ...
  beforeEach(() => {
    mockThemeService = jasmine.createSpyObj('IThemeService', ['changeTheme', 'getCurrentTheme']);

    TestBed.configureTestingModule({
      imports: [RefactoredComponent],
      providers: [{ provide: THEME_SERVICE, useValue: mockThemeService }],
    });
  });
